            ...
            <div className="overlap-group" >
                {isMounted && (
                    <FloatingPortal>
                        ...
                        ><div style={{ fontSize: '0.9vw', fontWeight: 600 }}>{bodyPartNames[bodypart as keyof typeof bodyPartNames] || bodypart}</div><div style={{
                            width: '14vw',
                            height: '8vw',
                            ...
                            backdropFilter: 'blur(0.3vw)',
                                ...
                                <div style={{ width: '0%', height: '10%', margin: '0.5vw', position: 'absolute' }}>
                                    ...
                                    <div style={{ width: '13vw', height: '1.2vw', backgroundColor: 'rgba(171, 171, 171,0.5)', backdropFilter: 'blur(0.4vw)', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '0.3vw' }}>
                                        ...
                                        <div style={{ width: '50%', background: 'rgba(166, 43, 43, 0.6)', display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                            {bodydamagecal[bodypart]?.broken ? 'Ja' : 'Nee'}
                                        </div>
                                    </div>
                                    <div style={{ width: '13vw', height: '1.2vw', backgroundColor: 'rgba(171, 171, 171,0.5)', backdropFilter: 'blur(0.4vw)', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '0.25vw' }}>
                                        ...
                                        <div style={{ width: '50%', background: 'rgba(166, 43, 43, 0.6)', display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                            {bodydamagecal[bodypart]?.severity ? 'Hoog' : 'Geen'}
                                        </div>
                                    </div>
                                    <div style={{ width: '13vw', height: '1.2vw', backgroundColor: 'rgba(171, 171, 171,0.5)', backdropFilter: 'blur(0.4vw)', display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '0.25vw' }}>
                                        <div style={{ width: '50%', display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                        ...
                                        <div style={{ width: '50%', background: 'rgba(166, 43, 43, 0.6)', display: 'flex', alignContent: 'center', alignItems: 'center', justifyContent: 'center' }}>
                                            {bodydamagecal[bodypart]?.bleeding ? 'Ja' : 'Nee'}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <Arrowright styles={{
                    ...
                    marginLeft: '11vw',
                    marginTop: '2.5vw',
                }} durablitystyles={{ width: '5vw', marginLeft: '15.5vw', marginTop: '1vw', position: 'absolute' }} label={'Hoofd'} percent={100 - bodydamagecal["HEAD"]?.percent} />
                <Arrowright styles={{
                    width: '10vw',
                    height: '1.8vw',
                    position: 'absolute',
                    marginLeft: '15vw',
                    marginTop: '9vw',
                }} durablitystyles={{ width: '5vw', marginLeft: '19.5vw', marginTop: '7.5vw', position: 'absolute' }} label={'Rechterarm'} percent={100 - bodydamagecal["RARM"]?.percent} />
                <Arrowright styles={{
                    width: '10vw',
                    height: '1.8vw',
                    position: 'absolute',
                    marginLeft: '12vw',
                    marginTop: '26vw',
                }} durablitystyles={{ width: '5vw', marginLeft: '16.5vw', marginTop: '24.5vw', position: 'absolute' }} label={'Rechterbeen'} percent={100 - bodydamagecal["RLEG"]?.percent} />
                <Arrowleft styles={{
                    width: '10vw',
                    height: '1.8vw',
                    position: 'absolute',
                    marginLeft: '1.2vw',
                    marginTop: '26vw',
                }} durablitystyles={{ width: '5vw', marginLeft: '1.7vw', marginTop: '24.5vw', position: 'absolute' }} label={'Linkerbeen'} percent={100 - bodydamagecal["LLEG"]?.percent} />
                <Arrowleft styles={{
                    width: '10vw',
                    height: '1.8vw',
                    position: 'absolute',
                    marginLeft: '1.2vw',
                    marginTop: '9vw',
                }} durablitystyles={{ width: '5vw', marginLeft: '1.8vw', marginTop: '7.5vw', position: 'absolute' }} label={'Linkerarm'} percent={100 - bodydamagecal["LARM"]?.percent} />
